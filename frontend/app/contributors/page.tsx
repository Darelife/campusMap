  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: "15px", color: "#555", margin: "0 0 40px 0", lineHeight: "1.6" }}>
        ...
        <section style={{ marginBottom: "40px" }}>
          <h2 style={{ fontSize: "22px", borderBottom: "1px solid #ddd", paddingBottom: "8px", margin: "0 0 20px 0", color: "#222" }}>
            2025-26 Sem 2
          </h2>
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
            {CONTRIBUTORS_2025_SEM2.map((c) => (
              ...
              >
                ...
                <div style={{ fontSize: "14px", fontWeight: "bold", color: "#444", marginBottom: "8px" }}>
                  {c.role}
                </div>
        ...
        <section style={{ marginTop: "40px", paddingTop: "20px", borderTop: "1px solid #ddd" }}>
          ...
          <p style={{ fontSize: "15px", color: "#555", lineHeight: "1.6", margin: "0 0 15px 0" }}>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            style={{ color: "#0066cc", textDecoration: "none", fontSize: "15px" }}
          >
            View on GitHub &rarr;
          </a>
        </section>
